...
<CardGroup cols={2}>
  <Card title="Add events" icon="calendar-days" href="/events">
    Display events, appointments, and markers on calendar dates
  </Card>
  <Card title="Customize styling" icon="palette" href="/customization">
    Change colors, fonts, and spacing to match your design
  </Card>
  <Card title="Range selection" icon="calendar-range" href="/range-selection">
    Allow users to select date ranges for bookings and reservations
  </Card>
  <Card title="Custom builders" icon="code" href="/builders">
